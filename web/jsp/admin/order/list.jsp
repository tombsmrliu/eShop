...
<HEAD>
    ...
    <script language="javascript" src="${pageContext.request.contextPath}/jsp/js/public.js"></script>

    <!-- 弹出层插件 -->
    <link href="${pageContext.request.contextPath}/jsp/css/popup_layer.css" type="text/css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsp/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsp/js/popup_layer.js"></script>
    <!-- 调用插件弹出层的方法 -->
    <script type="text/javascript">
        ...
        function findOrderInfoById(oid) {

              //ajax异步访问数据
              $.ajax({
                  url:"${pageContext.request.contextPath}/adminController?method=findOrderInfoById",
                  data:{"oid":oid},
                  dataType:"json",
                  success:function (data) {
                      ...
                      for(var i=0;i<data.length;i++){
                          content+="<tr style='text-align: center;'>"+
                              "<td>"+
                              "<img src='${pageContext.request.contextPath }/jsp/"+data[i].pimage+"' width='70' height='60'>"+
                              "</td>"+
...
<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/jsp/user/list.jsp" method="post">
                    ...
                    <c:forEach items="${orderList}" var="order" varStatus="vs">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <input type="button" value="订单详情" class="clickedElement" onclick="findOrderInfoById('${order.oid}')"
                                       />
                            </td>
...
<div id="showDiv" class="blk" style="display:none;">
    <div class="main">
        ...
        <div id="loading" style="padding-top:30px;text-align: center;">
            <img alt="" src="${pageContext.request.contextPath }/jsp/images/loading.gif">
        </div>
        <div style="padding:20px;">
            <table id="showDivTab" style="width:100%">
                ...
                <tr style='text-align: center;'>
                    <td>
                        <img src='${pageContext.request.contextPath }/jsp/products/1/c_0014' width='70' height='60'>
                    </td>
