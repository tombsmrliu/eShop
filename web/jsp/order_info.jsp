...
<body>
	...
	<div class="container">
						...
						<c:forEach items="${order.orderItems}" var="orderItem">
								...
								<tr class="active">
									<td width="60" width="40%">
										<img src="${pageContext.request.contextPath}/jsp/${orderItem.product.pimage}" width="70" height="60">
									</td>
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath}/productController" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="addr" id="address" value="">
					</div>
				</div>
				<div class="form-group">
					<label for="fullname" class="col-sm-1 control-label">收货人</label>
					<div class="col-sm-5">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				...
				<p>
					<br /> <input type="radio" name="pd_FrpId" value="ICBC-NET-B2C"
						checked="checked" />工商银行 <img src="jsp/bank_img/icbc.bmp"
						align="middle" />&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
						name="pd_FrpId" value="BOC-NET-B2C" />中国银行 <img
						src="jsp/bank_img/bc.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="pd_FrpId" value="ABC-NET-B2C" />农业银行 <img
						src="jsp/bank_img/abc.bmp" align="middle" /> <br /> <br /> <input
						type="radio" name="pd_FrpId" value="BOCO-NET-B2C" />交通银行 <img
						src="jsp/bank_img/bcc.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="pd_FrpId" value="PINGANBANK-NET" />平安银行
					<img src="jsp/bank_img/pingan.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />建设银行 <img
						src="jsp/bank_img/ccb.bmp" align="middle" /> <br /> <br /> <input
						type="radio" name="pd_FrpId" value="CEB-NET-B2C" />光大银行 <img
						src="jsp/bank_img/guangda.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="pd_FrpId" value="CMBCHINA-NET-B2C" />招商银行
					<img src="jsp/bank_img/cmb.bmp" align="middle" />

				</p>
				<hr />
				<p style="text-align: right; margin-right: 100px;">
					<a href="javascript:void(0);" onclick="confirmOrder()">
						<img src="jsp/images/finalbutton.gif" width="204" height="51"
						border="0" />
					</a>
				</p>
				<hr />
